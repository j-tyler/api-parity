...
api-parity follows links to build chains up to 6 steps by default (configurable via `--max-steps`). Deeper chains find more subtle bugs but take longer to execute.
