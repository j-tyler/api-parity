...
For each numbered item from your previous `/paranoid-review`, do a deep dive to fully understand the problem. Read the relevant code, trace the logic, and gather concrete evidence. Reference items by their original number (e.g., "Issue #1", "Issue #2").
